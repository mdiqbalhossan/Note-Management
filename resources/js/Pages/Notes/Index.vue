...
<template>
    <Head title="Student Class" />
    <AuthenticatedLayout>
        <DeleteModal v-model="data.show" :id="data.id" route="class.destroy" />
        <div class="p-2 my-4">
            <div
                ...
                >
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="py-4 px-6">{{ s_class.name }}</td>
                            <td class="py-4 px-6">
                                {{
                                    s_class.status == 1
                                        ? "Published"
                            ...
                            <td class="py-4 px-6">
                                <Link
                                    :href="route('class.edit', s_class.id)"
                                    as="button"
